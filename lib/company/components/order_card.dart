...
import '../companyOrders/model/order_company_model.dart';

class CompanyOrderCardItem extends StatelessWidget {
  final bool showPrice;
  final CompanyOrderProduct product;
  final bool showQuantity;

  const CompanyOrderCardItem({
    super.key,
    this.showPrice = true,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          if (showQuantity)
                            Text(
                              "${t.price}: ${product.price?.toStringAsFixed(2)} ${t.sar}",
